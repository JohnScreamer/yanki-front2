        ...
        <footer>
            <div className="Container text-originText-dark dark:text-originText-light bg-white dark:bg-main-dark relative z-50">
                <div className="md:flex justify-between py-6 hidden ">
                    ...
                    <div>
                        <h2 className="mb-5 text-xl uppercase">Контакти</h2>
                        <ul>
                ...
                <div className="md:hidden block bg-white dark:bg-main-dark ">
                    ...
                    <div className="flex justify-center flex-col w-full item-center pt-5">
                        <h2 className="mb-5 text-xl uppercase text-center">
                            Контакти
                        </h2>
                        <ul className="flex justify-center flex-col ">
                            <li className="flex mb-1 mx-auto">
                                <Link href={"#"}>
                                    <svg
                                        width="17"
                                        height="17"
                            ...
                            <li className="font-extralight mb-1 mx-auto">
                                <Link href={"#"} className="text-center">
                                    info@yanki.com
                                </Link>
                            </li>
                            <li className="font-extralight mx-auto">
                                <Link href={"#"} className="text-center">
                                    +38(073) 096 36 44
                                </Link>
                            </li>
