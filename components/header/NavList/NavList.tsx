...
const NavList: FC<NavListType> = ({ setSearchStatus, searchStatus }) => {
    ...
    useEffect(() => {
        setStatus(route.pathname === "/");
    }, [route.pathname]);
    return (
        <>
            <ul className={isHome ? s.wrapper : s.wrapperMain}>
                ...
                <li className="relative" onClick={handlerGotoFavorite}>
                    <svg
                        width="25"
                        height="24"
                        viewBox="0 0 25 24"
                    ...
                    {!!totalFavorite ? (
                        <div className=" bg-base2-light dark:bg-accentActive-dark font-bold text-base-light w-[29px] h-[29px]  rounded-full absolute bottom-[15px] left-[10px]">
                            <span className="absolute top-1/2 left-1/2 text-sm font-sans translate-x-[-50%] m-auto translate-y-[-50%] ">
                                {totalFavorite > 99 ? "99+" : totalFavorite}
                            </span>
                        </div>
                    ) : null}
                </li>
                <li className="relative" onClick={handlerGotoCart}>
                    <svg
                        width="25"
                        height="25"
                        viewBox="0 0 25 25"
